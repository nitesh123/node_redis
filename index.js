...
function RedisClient(stream, options) {
  ...
  if (exports.log_to_file) {
    var path = "./tests/logs/redis-debug.log"
      log_stream = fs.createWriteStream(path, {
        flags : 'a+'
      })
  }
...
RedisClient.prototype.send_command = function (command, args, callback) {
  ...
  if (command === "flush") {
    ...
    if (exports.log_to_file && buffer_args) {
      write_str += "send_command buffered_writes: " + buffered_writes,
      " should_buffer: " + this.should_buffer;
    }
...
commands = set_union(["get", "set", "setnx", "setex", "append", "strlen", "del", "exists", "setbit", "getbit", "setrange", "getrange", "substr",
      ...
      "zinterstore", "zrange", "zrangebyscore", "zrevrangebyscore", "zcount", "zrevrange", "zcard", "zscore", "zrank", "zrevrank", "zrevrangebylex", "zrangebylex", "zlexcount", "hset", "hsetnx",
